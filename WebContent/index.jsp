	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.jsp"><span>Market Wormhole</span></a>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						...
						<li class="dropdown" id="username">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> Jainam Shah
...
<!-- 						</li> -->
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list metro">
							<li class="green">
								<a href="#">
									<img class="avatar" alt="Jainam Shah" src="img/avatar.jpg">
								</a>
								<strong>Name:</strong> Jainam Shah<br>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2013 <a href="http://themifycloud.com/downloads/janux-free-responsive-admin-dashboard-template/" alt="Bootstrap_Metro_Dashboard">Market Wormhole Responsive Dashboard</a></span>
