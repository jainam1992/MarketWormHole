			...
			<div class="container-fluid">
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						...
						<!-- start: User Dropdown -->
						<li class="dropdown" id="username"><a
							class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> <%=request.getParameter("username")%> <span
								class="caret"></span>
						</a>
						...
						<div class="box-content">
							<ul class="dashboard-list metro">
								<li class="green"><a href="#"> <img class="avatar"
										alt="Jainam Shah" src="img/avatar.jpg">
								</a> <strong>Name:</strong> Jainam Shah<br> <strong>Since:</strong>
