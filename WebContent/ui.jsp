		...
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				...
				<ul class="breadcrumb">
					...
					<li><i class="icon-eye-open"></i> <a href="#">UI Features</a>
					</li>
				</ul>
				...
				<div class="row-fluid">
					<div class="box yellow span12">
						<div class="box-header">
							<h2>
								<i class="halflings-icon white white tasks"></i><span
									class="break"></span>Sliders
							</h2>
						</div>
								...
								<tr>
									<td>
										...
										<div class="field_notice">
											Min: <span class="must sliderMinLabel">$180</span>
										</div>
									</td>
								</tr>
								<tr>
									<td>
										...
										<div class="field_notice">
											Max: <span class="must sliderMaxLabel">$280</span>
										</div>
									</td>
								</tr>
								<tr>
									<td>
										...
										<div class="field_notice">
											Price Range: <span class="must sliderRangeLabel">$192
												- $470</span>
										</div>
									</td>
								</tr>
				...
				<div class="row-fluid">
					<div class="box blue span12">
						<div class="box-header">
							<h2>
								<i class="halflings-icon white white hand-top"></i><span
									class="break"></span>Quick Buttons
							</h2>
						</div>
						<div class="box-content">

							<a class="quick-button span2"> <i class="icon-group"></i>
								<p>Users</p> <span class="notification blue">1.367</span>
							</a> <a class="quick-button span2"> <i class="icon-comments-alt"></i>
								<p>Comments</p> <span class="notification green">167</span>
							</a> <a class="quick-button span2"> <i class="icon-shopping-cart"></i>
								<p>Orders</p>
							</a> <a class="quick-button span2"> <i class="icon-barcode"></i>
								<p>Products</p>
							</a> <a class="quick-button span2"> <i class="icon-envelope"></i>
								<p>Messages</p>
							</a> <a class="quick-button span2"> <i class="icon-calendar"></i>
								<p>Calendar</p> <span class="notification red">68</span>
							</a>
				...
				<div class="row-fluid">
					<div class="box span12">
						<div class="box-header">
							<h2>
								<i class="halflings-icon white white hand-top"></i><span
									class="break"></span>Small Quick Buttons
							</h2>
						</div>
						<div class="box-content">

							<a class="quick-button-small span1"> <i class="icon-group"></i>
								<p>Users</p> <span class="notification blue">7</span>
							</a> <a class="quick-button-small span1"> <i
								class="icon-comments-alt"></i>
								<p>Comments</p> <span class="notification green">4</span>
							</a> <a class="quick-button-small span1"> <i
								class="icon-shopping-cart"></i>
								<p>Orders</p>
							</a> <a class="quick-button-small span1"> <i class="icon-barcode"></i>
								<p>Products</p>
							</a> <a class="quick-button-small span1"> <i
								...
								<p>Calendar</p> <span class="notification red">8</span>
							</a> <a class="quick-button-small span1"> <i class="icon-beaker"></i>
								<p>Projects</p>
							</a> <a class="quick-button-small span1"> <i
								class="icon-thumbs-up"></i>
								<p>Likes</p> <span class="notification green">1</span>
							</a> <a class="quick-button-small span1"> <i
								class="icon-heart-empty"></i>
								<p>Favorites</p>
							</a> <a class="quick-button-small span1"> <i
								class="icon-bullhorn"></i>
								<p>Notifications</p> <span class="notification yellow">7</span>
							</a> <a class="quick-button-small span1"> <i class="icon-cogs"></i>
								<p>Settings</p>
							</a> <a class="quick-button-small span1"> <i
				...
				<div class="row-fluid">
					<div class="box span12">
						<div class="box-header">
							<h2>
								<i class="halflings-icon white white tasks"></i><span
									class="break"></span>Progress Bars
							</h2>
						</div>
						<div class="box-content">
							<table class="table table-striped">
								...
								<tr>
									...
									<td>
										...
										<div class="field_notice">
											Value: <span class="must progressAnimateValue">0%</span>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<div class="field_notice">
											Uploading: <span class="must progressUploadAnimateValue">0
												Mb</span> / 4096 Gb
										</div>
									</td>
								</tr>
				...
				<div class="row-fluid">
					<div class="box span12">
						<div class="box-header">
							<h2>
								<i class="halflings-icon white white tasks"></i><span
									class="break"></span>Standard Progress Bars
							</h2>
							<div class="box-icon">
				...
				<div class="row-fluid">
					<div class="box span12">
						...
						<div class="box-header">
							<h2>
								<i class="halflings-icon white white bullhorn"></i><span
									class="break"></span>Alerts
							</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i
									class="halflings-icon white wrench"></i></a> <a href="#"
				...
				<div class="row-fluid">
					<div class="box span12">
						...
						<div class="box-header">
							<h2>
								<i class="halflings-icon white white bell"></i><span
									class="break"></span>Growl Like Notifications
							</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i
									class="halflings-icon white wrench"></i></a> <a href="#"
						...
						<div class="box-content">
							...
							<p class="center">
								<button class="btn btn-primary" id="add-regular">
									<i class="halflings-icon white white bell"></i>Regular
								</button>
								<button class="btn btn-primary" id="add-sticky">
									<i class="halflings-icon white white bell"></i>Sticky
								</button>
								<button class="btn btn-primary" id="add-without-image">
									<i class="halflings-icon white white bell"></i>w/o image
								</button>
								<button class="btn btn-primary" id="add-gritter-light">
									<i class="halflings-icon white white bell"></i>White
								</button>
								<button class="btn btn-primary" id="remove-all">
									<i class="halflings-icon white white bell"></i>Remove All
								</button>
							</p>
						</div>
				...
				<div class="row-fluid">
					<div class="box span12">
						...
						<div class="box-header">
							<h2>
								<i class="halflings-icon white bell"></i><span class="break"></span>Bootstrap
								Notifications
							</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i
						...
						<div class="box-content">
							...
							<p class="center">
								<button class="btn btn-primary noty"
									...
									<i class="halflings-icon white white bell"></i> Top Left
								</button>
								<button class="btn btn-primary noty"
								...
								<button class="btn btn-primary noty"
									...
									<i class="halflings-icon white white bell"></i> Bottom Right
									(fade)
								</button>

								<button class="btn btn-primary noty"
									data-noty-options='{"text":"This is an alert","layout":"bottom","type":"alert","closeButton":"true"}'>
									<i class="halflings-icon white white bell"></i> Bottom Full
				...
				<div class="row-fluid">
					<div class="box span4">
						<div class="box-header">
							<h2>
								<i class="halflings-icon white plus"></i><span class="break"></span>Extended
								Elements
							</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i
						...
						<div class="box-content">
							<table class="table table-bordered table-striped">
								<tr>
									<td>Star Rating</td>
									<td><span class="rating"> <span class="star"></span><span
								...
								<tr>
									<td>Popover</td>
									<td><a href="#" class="btn btn-danger" data-rel="popover"
										data-content="And here's some amazing content. It's very engaging. right?"
										title="A Title">Hover for popover</a></td>
								</tr>
								<tr>
									<td>Dialog</td>
								...
								<tr>
									...
									<td><a href="#"
										...
										data-rel="tooltip" class="btn btn-warning">Hover for
											tooltip</a></td>
								</tr>
							</table>
						</div>
					...
					<div class="box span2">
						<div class="box-header">
							<h2>
								<i class="halflings-icon white eye-open"></i><span class="break"></span>Labels
							</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i
									class="halflings-icon white wrench"></i></a> <a href="#"
					...
					<div class="box span6">
						<div class="box-header">
							<h2>
								<i class="halflings-icon white list"></i><span class="break"></span>Buttons
							</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i
									class="halflings-icon white wrench"></i></a> <a href="#"
						...
						<div class="box-content buttons">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a href="#"><i class="halflings-icon white star"></i>
											Action</a></li>
									<li><a href="#"><i class="halflings-icon white tag"></i>
											Another action</a></li>
									<li><a href="#"><i
											class="halflings-icon white download-alt"></i> Something else
											here</a></li>
									<li class="divider"></li>
									<li><a href="#"><i class="halflings-icon white tint"></i>
											Separated link</a></li>
								</ul>
							</div>
							...
							<p>
								<button class="btn btn-small">
									<i class="halflings-icon white white star"></i> Icon button
								</button>
							...
							<p>
								...
								<button class="btn btn-large btn-round">
									<i class="halflings-icon white white ok"></i>
								</button>
				...
				<div class="row-fluid">
					...
					<div class="box span12">
						<div class="box-header">
							<h2>
								<i class="halflings-icon white th"></i><span class="break"></span>Tabs
							</h2>
						</div>
						<div class="box-content">
