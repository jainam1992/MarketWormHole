    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <button type="button" class="btn btn-primary" onclick="window.open('login.jsp')">View Prediction</button>
                
                </div>
                
                <div class="col-lg-6">
                <img src="https://www.google.com/finance/getchart?q=AAPL&p=20Y&i=86400" />
            	</div>
            </div>
        </div>
    </section>
...
<!-- TradingView Widget END -->
    ...
    <div class="container">
      <p class="navbar-text pull-left">Copyright @ Market Wormhole 2016.
